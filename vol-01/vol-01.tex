...
~
\vfill
\noindent{The contents of this book are in the public domain in\newline both the United States and Japan and may be freely\newline copied and distributed.}
\\[12pt]
\noindent{2017}
\vfill
~
...
\chapter*{\centering II}
\addcontentsline{toc}{chapter}{II}
SINCE New Year's Day I have acquired a certain modest ce\-leb\-ri\-ty: so
...
\blockquote{Took a stroll with Coldmoon round Nezu, Ueno, Ikenohata and Kanda. At
...
\blockquote{As we turned at Hotan's corner another geisha appeared. She was slim,
...
\blockquote{We dined somewhere in Kanda. Because I allowed myself one or two cups of
...
\blockquote{The other day, Mr.~X claimed that going without one's breakfast helped
...
\blockquote{A small Princess-pine
...
\blockquote{Yesterday, finding a minute to spare, I sought to treat Mr. Beauchamp to
...
\blockquote{Tomorrow there will be a card party at a certain Baron's house; the day
...
\blockquote{So you see, because of these incessant parties--- nō song parties, haiku
...
\blockquote{Next time that you are kind enough to visit me, I would like you to stay
...
\blockquote{However, because the ingredients necessary for the preparation of
...
\blockquote{As you know, the tongue meat per peacock amounts to less than half the
...
\blockquote{I think one needs to catch at least twenty or thirty peacocks. However,
...
\blockquote{The dish of peacocks' tongues was once extremely fashionable in Rome
...
\blockquote{From that time forward until about the sixteenth century, peacock was an
...
\blockquote{Anyway, if I go on eating good food as I have been doing recently, I
...
\blockquote{According to historians, the Romans held two or three banquets every
...
\blockquote{But they, who studied long and hard simultaneously to enjoy both luxury
...
\blockquote{They invariably took a post-prandial bath. After the bath, utilizing
...
\blockquote{Today, this twentieth century, quite apart from the heavy traffic and
...
\blockquote{Now suppose that we, who are familiar with all things Occidental, by
...
\blockquote{Accordingly, I have now, for some time, been digging into the relevant
...
\blockquote{Kate looks out of the window. Children are playing ball. They throw the
...
\blockquote{Last night a tiny whore of sixteen summers
...
would declare without fear of contradiction that the nose of Mrs. Goldfield is superb, superlative, and, though possibly supervacaneous,
